...
procedure TF_tm_notmusic.Btn_hist_avncClick(Sender: TObject);
begin
...
procedure TF_tm_notmusic.Btn_hist_avncEnter(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
...
procedure TF_tm_notmusic.Btn_hist_avncExit(Sender: TObject);
begin
voz.Pause;
...
procedure TF_tm_notmusic.Btn_hist_exEnter(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
...
procedure TF_tm_notmusic.Btn_hist_exExit(Sender: TObject);
begin
voz.Pause;
...
procedure TF_tm_notmusic.Btn_hist_explEnter(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
...
procedure TF_tm_notmusic.Btn_hist_explExit(Sender: TObject);
begin
voz.Pause;
...
procedure TF_tm_notmusic.Btn_hist_fexrClick(Sender: TObject);
begin
F_TM_Notmusic.Close;
end;

procedure TF_tm_notmusic.Btn_hist_fexrEnter(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
...
procedure TF_tm_notmusic.Btn_hist_fexrExit(Sender: TObject);
begin
voz.Pause;
...
procedure TF_tm_notmusic.Btn_hist_ovratClick(Sender: TObject);
begin
voz:=createOLEObject('SAPI.SpVoice');
if crt_textoatual=2 then
begin
...
procedure TF_tm_notmusic.Btn_hist_ovratEnter(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
...
procedure TF_tm_notmusic.Btn_hist_ovratExit(Sender: TObject);
begin
voz.Pause;
...
procedure TF_tm_notmusic.Btn_hist_ovrClick(Sender: TObject);
begin
...
procedure TF_tm_notmusic.Btn_hist_ovrEnter(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
...
procedure TF_tm_notmusic.Btn_hist_ovrExit(Sender: TObject);
begin
voz.Pause;
...
procedure TF_tm_notmusic.Btn_hist_vltrClick(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
crt_textoatual:= crt_textoatual-1;
if crt_textoatual=2 then
...
procedure TF_tm_notmusic.Btn_hist_vltrEnter(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
...
procedure TF_tm_notmusic.Btn_hist_vltrExit(Sender: TObject);
begin
voz.Pause;
...
procedure TF_tm_notmusic.FormClose(Sender: TObject; var Action: TCloseAction);
begin
crt_falainic:=0;
end;

procedure TF_tm_notmusic.FormShow(Sender: TObject);
begin
voz:=CreateOLEObject('SAPI.SpVoice');
voz.Speak('Nova Tela aberta, Histórico da Musicografia Braille',SVSFlagsAsync);
end;
